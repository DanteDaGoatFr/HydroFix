...
main() {
    ...
    curl --insecure "https://setup.rbxcdn.com/mac/version-2178d23686534193-RobloxPlayer.zip" -o "./RobloxPlayer.zip"
    ...
    curl --insecure -LJO "https://github.com/retguard/improved-octo-meme/raw/main/libHydrogen.dylib"

    rm ./insert_dylib
    echo -e "Downloading insert_dylib"
    curl --insecure -LJO "https://github.com/retguard/legendary-couscous/raw/main/insert_dylib"
